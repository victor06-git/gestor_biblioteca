...
public class Main {
    ...
    public static void menuLlistarPrestecs() {
        ...
        while (!sortir) {
            ...
            System.out.println("3. Actius");
            System.out.println("4. Fora de termini");
            ...
            switch (opcio) {
                ...
                case "2":
                case "per usuari":
                    System.out.println("\nHas seleccionat 'Per usuari'");
                    Scanner scanner2 = new Scanner(System.in);
                    System.out.print("Introdueix l'ID de l'usuari: ");
                    int idUsuari = scanner2.nextInt();
                    System.out.println(llistatPrestecsUsuari(idUsuari));
                    break;
    ...
    public static void eliminar_prestecs() {
        ...
        try {
            ...
            if (prestecAEliminar != null) {
                ...
                System.out.print("\nVols eliminar aquest préstec? (s/n): \n");
                ...
                if (confirmacio.equalsIgnoreCase("s")) {
                    ...
                    System.out.println("\nNo s'ha eliminat el préstec amb ID " + idPrestecEliminar + "\n");
                    menuPrestecs();
                }
            } else {
